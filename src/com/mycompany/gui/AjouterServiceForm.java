 ...
 * @author Nour
 */
public class AjouterServiceForm extends BaseForm{
    
    Form current;
    public AjouterServiceForm(Resources res){
        ...
        TextField descreption= new TextField("","entrer Descreption ");
        descreption.setUIID("TextFieldBlack");
        addStringValue("Objet",descreption);
        ...
        btnAjouter.addActionListener((e)->{
            ...
            try {
                if(title.getText().equals("") || descreption.getText().equals("")|| prix.getText().equals("")){
                    ...
                    Service s = new Service(String.valueOf(title.getText()).toString(),
                            String.valueOf(descreption.getText()).toString(),
                            String.valueOf(prix.getText()).toString(),
                            format.format(new Date()));
                    System.out.println("Data Service = "+s);
                    ServiceService.getInstance().ajouterService(s);
                    iDialog.dispose();
