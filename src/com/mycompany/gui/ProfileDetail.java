 ...
 * @author Hamza_Azzabi
 */
public class ProfileDetail extends BaseForm{
    public ProfileDetail(Resources res,User user) {
        ...
        addStringValue(user.getFirstName(), null);
        addStringValue(user.getLastName(), null);
        addStringValue(user.getEmail(), null);
    }
